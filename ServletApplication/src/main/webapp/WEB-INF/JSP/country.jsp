...
<body>
    ...
    <form action="/countries" method="post" class="form" id="form1">
     <div id="form-main">
       <p class="id">
      ...
      <p class="population">
        <input name="population" type="text" class="validate[required,custom[email]] feedback-input" id="population" placeholder="Population" />
      </p>
      <div class="submit">
